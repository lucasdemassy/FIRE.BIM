...
namespace AsImpL
{
    ...
    public abstract class Loader : MonoBehaviour
    {
        ...
        public IEnumerator Load(string objName, string absolutePath, Transform parentObj)
        {
            ...
            /*
            GameObject importer = GameObject.Find("Importer");
            AsImpL.Examples.AsImpLSample script = importer.GetComponent<AsImpL.Examples.AsImpLSample>();
            string loaded_string = script.Loaded.ToString();
            Text UIText = FindObjectOfType<Text>();
            UIText.text = loaded_string;
            GameObject objetBati = GameObject.Find("MyObject");
            GameObject maquette3d = objetBati.transform.GetChild(1).gameObject;
            UIText.text = maquette3d.name;
            */
        }
